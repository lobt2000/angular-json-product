...
export class CategoryComponent implements OnInit {
  ...
  addCategory(): void {
    if (this.categoryName.length > 0) {
      ...
      const newC = new Category(1, this.categoryName, this.categoryUrlName)
      delete newC.id
  ...
  editCategory(cat: ICategory): void {
    ...
    this.categoryUrlName = cat.urlName;
    this.editStatus = true;

  }
  saveCategory(): void {
    const saveC = new Category(1, this.categoryName, this.categoryUrlName)
